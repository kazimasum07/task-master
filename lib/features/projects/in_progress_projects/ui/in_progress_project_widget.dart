...
class InProgressProjectListWidget extends StatefulWidget {
  final double ?widthSize;
  final double ?heightSize;
  const InProgressProjectListWidget({this.widthSize,this.heightSize,super.key});

  @override
  State<InProgressProjectListWidget> createState() => _InProgressProjectListWidgetState();
}

class _InProgressProjectListWidgetState extends State<InProgressProjectListWidget> {
                    ...
                    children: [
                      Expanded(
                        ...
                        child: LinearProgressIndicator(
                          ...
                          valueColor: AlwaysStoppedAnimation<Color>(TMCustomColors.orangeColor),
                          minHeight: 6,
