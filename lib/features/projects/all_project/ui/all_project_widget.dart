...
import 'package:task_master/features/profile/project_details/ui/projects_details_screen.dart';
import 'package:task_master/widgets/constants/colors.dart';
import 'package:task_master/widgets/constants/sizes.dart';

class AllProjectListWidget extends StatefulWidget {
  final double ?widthSize;
  final double ?heightSize;
  const AllProjectListWidget({this.widthSize,this.heightSize,super.key});

  @override
  State<AllProjectListWidget> createState() => _AllProjectListWidgetState();
}

class _AllProjectListWidgetState extends State<AllProjectListWidget> {
