...
class CompletedProjectListWidget extends StatefulWidget {
  final double ?widthSize;
  final double ?heightSize;
  const CompletedProjectListWidget({this.widthSize,this.heightSize,super.key});

  @override
  State<CompletedProjectListWidget> createState() => _CompletedProjectListWidgetState();
}

class _CompletedProjectListWidgetState extends State<CompletedProjectListWidget> {
